...
def upgrade() -> None:
    ...
    op.drop_table('student_subject', cascade='CASCADE')
    op.drop_table('studentvak', cascade='CASCADE')
    op.drop_table('team', cascade='CASCADE')
    op.drop_table('groep', cascade='CASCADE')
    op.drop_table('indiening', cascade='CASCADE')
    op.drop_table('lesgevervak', cascade='CASCADE')
    op.drop_table('teacher_subject', cascade='CASCADE')
    op.drop_table('student_group', cascade='CASCADE')
    op.drop_table('website_user', cascade='CASCADE')
    op.drop_table('bestand', cascade='CASCADE')
    op.drop_table('project', cascade='CASCADE')
    op.drop_table('submission', cascade='CASCADE')
    op.drop_table('status', cascade='CASCADE')
    op.drop_table('studentgroep', cascade='CASCADE')
    op.drop_table('file', cascade='CASCADE')
    op.drop_table('subject', cascade='CASCADE')
    op.drop_table('vak', cascade='CASCADE')
    op.drop_table('website_user', cascade='CASCADE')
